...
1. [What You Need to Know Before Editing](#1-what-you-need-to-know-before-editing)
2. [Running the Project](#2-running-the-project)
   - [Validation commands](#validation-commands)
   - [Current player controls](#current-player-controls)
3. [The Project Map](#3-the-project-map)
   - [Where to start for different changes](#where-to-start-for-different-changes)
4. [How the Game Starts](#4-how-the-game-starts)
   - [`Game` is the application coordinator](#game-is-the-application-coordinator)
5. [Understanding the Game Loop](#5-understanding-the-game-loop)
   - [Why `GameClock` uses a fixed step](#why-gameclock-uses-a-fixed-step)
   - [Game time scale](#game-time-scale)
6. [The Simulation Facade](#6-the-simulation-facade)
   - [A useful modification pattern](#a-useful-modification-pattern)
7. [Hero Data and Generation](#7-hero-data-and-generation)
   - [The hero schema](#the-hero-schema)
   - [How initial heroes are created](#how-initial-heroes-are-created)
   - [Important determinism limitation](#important-determinism-limitation)
8. [Safe Recipe: Add an Occupation](#8-safe-recipe-add-an-occupation)
9. [Safe Recipe: Change Hero Appearance](#9-safe-recipe-change-hero-appearance)
10. [Living Refuge Behavior](#10-living-refuge-behavior)
    - [Daily schedule](#daily-schedule)
    - [Navigation points must stay synchronized with scenery](#navigation-points-must-stay-synchronized-with-scenery)
11. [Needs, Relationships, and Training](#11-needs-relationships-and-training)
    - [Needs](#needs)
    - [Relationships](#relationships)
    - [Training](#training)
12. [Skill Forge](#12-skill-forge)
    - [Skill data flow](#skill-data-flow)
    - [Safe recipe: add a skill](#safe-recipe-add-a-skill)
13. [Injuries, Recovery, and Permanent Death](#13-injuries-recovery-and-permanent-death)
    - [Injury state](#injury-state)
    - [Death and legacy](#death-and-legacy)
14. [Party and Formation](#14-party-and-formation)
    - [Atomic formation movement](#atomic-formation-movement)
    - [Squad readiness](#squad-readiness)
15. [Combat and Utility AI](#15-combat-and-utility-ai)
    - [Combat pipeline](#combat-pipeline)
    - [Combat timing and safety limits](#combat-timing-and-safety-limits)
    - [Safe recipe: rebalance damage](#safe-recipe-rebalance-damage)
16. [Expedition System](#16-expedition-system)
    - [Safe recipe: edit the first mission](#safe-recipe-edit-the-first-mission)
17. [Three.js Rendering](#17-threejs-rendering)
    - [Two 3D scenes](#two-3d-scenes)
    - [Current renderer settings](#current-renderer-settings)
    - [Resource cleanup rule](#resource-cleanup-rule)
18. [Safe Recipe: Add a Selectable Refuge Prop](#18-safe-recipe-add-a-selectable-refuge-prop)
19. [Procedural Hero Models and Portraits](#19-procedural-hero-models-and-portraits)
20. [DOM UI Architecture](#20-dom-ui-architecture)
    - [Stable player navigation](#stable-player-navigation)
    - [Current surfaces](#current-surfaces)
    - [Preventing unsafe HTML](#preventing-unsafe-html)
21. [Safe Recipe: Change or Add a UI Panel](#21-safe-recipe-change-or-add-a-ui-panel)
22. [Styling and Responsive Design](#22-styling-and-responsive-design)
23. [Notifications](#23-notifications)
24. [Developer Diagnostics](#24-developer-diagnostics)
25. [Implemented Phase Summary](#25-implemented-phase-summary)
26. [Phase 16 Reference: Memory System](#26-phase-16-reference-memory-system)
    - [Memory data](#memory-data)
    - [Memory ownership](#memory-ownership)
    - [Current event connections](#current-event-connections)
    - [Behavior effects](#behavior-effects)
    - [Reinforcement and decay](#reinforcement-and-decay)
    - [Presentation](#presentation)
    - [Phase 16 regression coverage](#phase-16-regression-coverage)
    - [Current scope boundary](#current-scope-boundary)
27. [Phase 17 Reference: Trait Evolution](#27-phase-17-reference-trait-evolution)
    - [Data model](#data-model)
    - [Rule ownership](#rule-ownership)
    - [Implemented conditions](#implemented-conditions)
    - [Event connections](#event-connections)
    - [UI and notifications](#ui-and-notifications)
    - [Safe recipe: add an earned trait](#safe-recipe-add-an-earned-trait)
28. [Phase 18 Reference: Recruitment and Procedural Character Forge](#28-phase-18-reference-recruitment-and-procedural-character-forge)
    - [Recruitment ownership](#recruitment-ownership)
    - [Stored appearance and prototype adaptation](#stored-appearance-and-prototype-adaptation)
    - [Resource and UI flow](#resource-and-ui-flow)
    - [Portrait lifecycle](#portrait-lifecycle)
    - [Safe recipe: change recruitment](#safe-recipe-change-recruitment)
29. [Phase 19 Reference: Hero Capacity and Dormitories](#29-phase-19-reference-hero-capacity-and-dormitories)
    - [Capacity and upgrade transactions](#capacity-and-upgrade-transactions)
    - [Comfort data flow](#comfort-data-flow)
    - [UI and world behavior](#ui-and-world-behavior)
    - [Safe recipe: modify Dormitory balance](#safe-recipe-modify-dormitory-balance)
30. [Phase 20 Reference: Resource Economy](#30-phase-20-reference-resource-economy)
    - [Current resource loop](#current-resource-loop)
    - [Food consumption](#food-consumption)
    - [Needs consequences](#needs-consequences)
    - [UI and notifications](#ui-and-notifications-1)
    - [Safe recipe: modify the economy](#safe-recipe-modify-the-economy)
31. [Phase 21 Reference: Refuge Layout System](#31-phase-21-reference-refuge-layout-system)
    - [Ownership map](#ownership-map)
    - [Placement transaction](#placement-transaction)
    - [Validation rules](#validation-rules)
    - [Dynamic hero destinations](#dynamic-hero-destinations)
