...
1. [Quick Start](#1-quick-start)
   - [1.1 Implemented Phase Map](#11-implemented-phase-map)
2. [Architecture](#2-architecture)
3. [Core Engine](#3-core-engine)
   - [3.1 Game Orchestrator](#31-game-orchestrator-srccoregamets)
   - [3.2 Game Clock](#32-game-clock-srccoregameclockts)
   - [3.3 Event Bus](#33-event-bus-srccoreeventbusts)
   - [3.4 Seeded Random](#34-seeded-random-srccorerandomts)
   - [3.5 Renderer](#35-renderer-srccorerendererts)
4. [Hero System](#4-hero-system)
   - [4.1 Hero Data Model](#41-hero-data-model-srcheroherots)
   - [4.2 Hero Generation](#42-hero-generation-srcheroherogeneratorts)
   - [4.3 Occupation Definitions](#43-occupation-definitions-srcherooccupationdefinitionsts)
   - [4.4 Needs System](#44-needs-system-srcheroeedssystemts)
   - [4.5 Daily Routine](#45-daily-routine-srcheroheroroutinesystemts)
   - [4.6 Training System](#46-training-system-srcheroetrainingsystemts)
   - [4.7 Injury System](#47-injury-system-srcheroeinjurysystemts)
   - [4.8 Relationship System](#48-relationship-system-srcheroerelationshipsystemts)
   - [4.9 Legacy / Memorial System](#49-legacy--memorial-system-srcherolegacyystemts)
   - [4.10 Memory System](#410-memory-system-srcmemoriesmemorysystemts)
   - [4.11 Trait Evolution](#411-trait-evolution-srcheroetraitevolutionsystemts)
   - [4.12 Recruitment](#412-recruitment-srcrecruitmentsystemts)
   - [4.13 Dormitory Capacity](#413-dormitory-capacity-srcrefugedormitoryystemts)
   - [4.14 Resource Economy](#414-resource-economy-srcEconomyresourceconomysystemts)
5. [Skill Forge](#5-skill-forge)
   - [5.1 Skill Data Model](#51-skill-data-model-srcskillsskillts)
   - [5.2 Skill Definitions](#52-skill-definitions-srcskillsskilldefinitionregistryts)
   - [5.3 Skill Progression](#53-skill-progression-srcskillsskillprogressionsystemts)
   - [5.4 Skill Discovery](#54-skill-discovery-srcskillsskilldiscoverysystemts)
   - [5.5 Skill Loadout](#55-skill-loadout-srcskillsskillloadoutystemts)
6. [Combat System](#6-combat-system)
   - [6.1 Combat Simulation](#61-combat-simulation-srccombatcombatsimulationts)
   - [6.2 Utility AI](#62-utility-ai-srccombatutilityaits)
   - [6.3 Formation System](#63-formation-system-srccombatformationsystemts)
7. [Squad & Expedition](#7-squad--expedition)
   - [7.1 Squad System](#71-squad-system-srcsquadsquadsystemts)
   - [7.2 Expedition System](#72-expedition-system-srcexpeditionsexpeditionsystemts)
8. [3D Rendering](#8-3d-rendering)
   - [8.1 Camera Controller](#81-camera-controller-srcrenderingcameracontrollerts)
   - [8.2 Selection Raycaster](#82-selection-raycaster-srcrenderingselectionraycasterts)
   - [8.3 Procedural Base Scene](#83-procedural-base-scene-srcrenderingproceduralbasescenets)
   - [8.4 Hero Renderer](#84-hero-renderer-srcrenderingheroesherorendererts)
   - [8.5 Hero Mesh Generator](#85-hero-mesh-generator-srcrenderingheroeshuereshgeneratorats)
   - [8.6 Hero Portrait Cache](#86-hero-portrait-cache-srcrenderingheroeshroportraitcachets)
   - [8.7 Refuge Layout Rendering](#87-refuge-layout-rendering-and-input)
   - [8.8 Combat Arena](#88-combat-arena-srcrenderingcombatcombatarenascenets)
9. [UI System](#9-ui-system)
   - [9.1 Design Pattern](#91-design-pattern)
   - [9.2 CSS Design System](#92-css-design-system-srcstylescssts)
   - [9.3 Panel Overview](#93-panel-overview)
   - [9.4 SelectionOverlay](#94-selectionoverlay-hero-detail)
10. [How to Modify (Recipes)](#10-how-to-modify-recipes)
    - [10.1 Add a New Occupation](#101-add-a-new-occupation)
    - [10.2 Add a New Skill](#102-add-a-new-skill)
    - [10.3 Add a New Injury Type](#103-add-a-new-injury-type)
    - [10.4 Add a New Combat Action to Utility AI](#104-add-a-new-combat-action-to-utility-ai)
    - [10.5 Add a New UI Panel](#105-add-a-new-ui-panel)
    - [10.6 Add a New Hero Trait](#106-add-a-new-hero-trait)
    - [10.7 Change Balance Numbers](#107-change-balance-numbers)
    - [10.8 Add a New Need/Stat](#108-add-a-new-needstat)
    - [10.9 Modify the 3D Scene](#109-modify-the-3d-scene)
    - [10.10 Validate a Change](#1010-validate-a-change)
    - [10.11 Modify Recruitment Safely](#1011-modify-recruitment-safely)
    - [10.12 Modify Dormitory Tiers Safely](#1012-modify-dormitory-tiers-safely)
    - [10.13 Modify the Resource Economy Safely](#1013-modify-the-resource-economy-safely)
