...
export class DebugOverlay {
  ...
  constructor(container: HTMLElement, private readonly actions: DebugActions) {
    ...
    this.element.innerHTML = `
      <header><div><span>DEVELOPER</span><strong>Phase 19 diagnostics</strong></div><button type="button" data-debug-action="close" aria-label="Close diagnostics">×</button></header>
